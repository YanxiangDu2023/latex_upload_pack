...
CRP & A Volvo CE internal data source that provides industry exchange-related reference data used in the TMC process \\
...
TMA & Total Market reference data used in the TMC process \\
