...
Several limitations nonetheless apply:
\begin{itemize}
    \item The prototype covers only selected stages of the broader TMC process. Formal evaluation was limited to source upload, preparation, market-view derivation, adjustment, and selected split and resplit outputs.
