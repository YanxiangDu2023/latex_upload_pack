...
To address the identified gap in transparency, inspectability, and usability in the SAP-based TMC implementation, this thesis develops a web-based artefact for Volvo CE that re-expresses selected parts of the TMC process in a browser-accessible environment. The implemented system covers authentication, CSV-based data upload, backend processing, workflow inspection, and review of intermediate and derived outputs for the preparation, market view, adjustment, machine line split, and resplit stages.
