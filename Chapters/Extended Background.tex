...
The construction equipment industry is a global and capital-intensive sector in which manufacturers operate across multiple regional markets and product segments \cite{cece2025,volvo2024annual}. For analytical purposes, markets are commonly structured by dimensions such as country, machine line, size class, and brand \cite{mordor2024construction,offhighway2024sample}. This multidimensional structure makes market analysis dependent on data integration and classification consistency rather than on a single uniform source.

This study focuses on the manufacturer perspective, specifically how firms estimate total market size and market share across different regions and product categories.
...
Given the competitive and international nature of the industry, market share is a key indicator for assessing position and supporting strategic decision-making \cite{porter1980competitive, kotler2016marketing}. However, total market size and market share are not derived from one universally standardized source. Instead, companies must combine internal sales data, industry-level exchange or aggregated data, and external third-party inputs.
