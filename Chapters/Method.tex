...
At the same time, the research clearly used the Volvo CE case as its empirical grounding. The broader design problem concerns transparency, traceability, and usability in ERP-based enterprise workflows, but that problem was studied through one concrete setting: the TMC process at Volvo CE. In this thesis, DSR provides the overall research logic, while the case setting provides the practical context in which the problem, artefact, and evaluation can be understood.
