...
This thesis asks how complex enterprise data-processing workflows can be made easier for business users to inspect when they depend on heterogeneous inputs, maintained rules, and staged transformations. The Volvo CE TMC process is used as the empirical case setting for that question.
...
This thesis focuses on the design and implementation of a web-based prototype for selected stages of the Volvo CE TMC process. The implemented scope covers source-data upload, matrix input handling, preparation, market view, adjustment, machine line split, and resplit. The prototype provides interfaces for workflow navigation, layer-based visualization, interactive table exploration, filtering, summary calculation, and CSV export.
