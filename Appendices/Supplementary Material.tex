...
\begin{figure}[H]
    \centering
\includegraphics[width=\linewidth]{5.4.1.png}
...
\begin{figure}[H]
    \centering
\includegraphics[width=\linewidth]{5.6.1.1.1.png}
...
\begin{figure}[H]
    \centering
\includegraphics[width=\linewidth]{5.6.1.2.png}
...
\begin{figure}[H]
    \centering
\includegraphics[width=\linewidth]{5.6.1.3.png}
...
\small
\begin{longtable}{|>{\raggedright\arraybackslash}p{2.2cm}|>{\raggedright\arraybackslash}p{3.0cm}|>{\raggedright\arraybackslash}p{5.7cm}|}
...
FR2 Functional fulfilment & Can backend logic generate staged workflow outputs for the selected TMC stages? & Yes. The backend generated staged outputs for OTH deletion and reporter-base processing, preparation, market view, adjustment, and split and resplit. These outputs were used for later inspection, comparison, and validation against expected workflow logic. \\
\hline

FR3 Functional fulfilment & Does the artefact support a modular web-based frontend-backend workflow? & Yes. The prototype operated with separated frontend pages, backend report and processing routes, and relational storage for uploaded and derived records. Upload, processing, storage, workflow inspection, and visualization were implemented as separate functions, supporting a modular workflow structure. \\
\hline
...
\begin{itemize}[leftmargin=*, nosep]
    ...
    \item About 20\% of market-view rows and 10\% of split and resplit rows were spot-checked. The sampled records were consistent with expected calculations, split-case selection, redistribution logic, and before/after total preservation. One split-ratio discrepancy was recorded as a rule-clarification finding.
\end{itemize}
\\
\hline
...
PR2 Performance and stability & Is behavior stable during repeated upload, run, filter, save, reload, and export cycles? & 
...
\begin{itemize}[leftmargin=*, nosep]
    ...
    \item No crash, data loss, or inconsistent save/reload behavior was observed.
\end{itemize}
\\
\hline
